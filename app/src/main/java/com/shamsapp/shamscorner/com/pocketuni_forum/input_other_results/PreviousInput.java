...
import com.shamsapp.shamscorner.com.pocketuni_forum.attendance.OverallAttendance;
 ...
 */
public class PreviousInput extends AppCompatActivity {
    ...
    private String username_text = null, inputType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inflater = LayoutInflater.from(PreviousInput.this);
            ...
            for(int i = 0; i<loop; i++){
                ...
                touchingContent.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getApplicationContext(), OverallAttendance.class); // this has to change
