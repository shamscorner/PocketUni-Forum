...
import com.shamsapp.shamscorner.com.pocketuni_forum.attendance.InsertingAtten;
...
public class TeacherInput extends AppCompatActivity {
    ...
    private String username_text, inputType;
            ...
            alertDialogBuilder
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(getApplicationContext(), Inserting.class);
